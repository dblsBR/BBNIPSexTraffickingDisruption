...
def SO_Pes_SpecialArcs (G, s, t, budget, rate, restriction):
    ...
    model.addConstrs(gp.quicksum(x[v,u] for u in G1.successors(v)) - gp.quicksum(x[u,v] for u in G1.predecessors(v)) == 0 for v in G1.nodes); 
