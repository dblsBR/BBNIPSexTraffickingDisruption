...
from readNet import*;
from Opt_Victims import*;
from Pes_Traffickers import*;
from Opt_Vic_Const import*;
...
for n in range(1, nNets+1):
    ...
    Name = "Results/Results_"+str(n)+"/DifferentCapacities/Results_O-BBNIP2_"+str(n)+"_.csv"
    print('\n\nDifferent Capacities\n')
    
    # # ------ Same Capacities
    # network = "Networks/SameCapacities/Net10_"+str(n)+"_SameCap.csv";
    # Name = "Results/Results_"+str(n)+"/SameCapacities/Results_O-BBNIP2_"+str(n)+"_.csv"
    # print('\n\nSame Capacities\n')
    
    # # ------ Operations Same Capacities
    # network = "Networks/OperationsSameCapacities/Net10_"+str(n)+"_OpSameCap.csv";
    # Name = "Results/Results_"+str(n)+"/OperationsSameCapacities/Results_O-BBNIP2_"+str(n)+"_.csv"
    # print('\n\nOperations Same Capacities\n')
    ...
    for budget in Budget:
        ...
        for rate in Rate:
            ...
            obj_victims, Gamma_Vic = Opt_Victims (G_r, s, t, budget, rate, restriction);
            
            obj_traffickers, Gamma_Tra = Pes_Traffickers (G_r, s, t, budget, rate, restriction);
            
            obj_vic_const, Gamma_Vic_Const = Opt_Vic_Const (G_r, s, t, budget, rate, obj_traffickers, Gamma_Tra, restriction);
            
            obj_tra_const, Gamma_Tra_Const = Pes_Tra_Const (G_r, s, t, budget, rate, obj_victims, Gamma_Vic, restriction);
            

            print('\nOptimistic Biobjective: Victims vs Traffickers \n');
            ...
            if delta == 0:
                ...
                while temp_tra < obj_tra_const:    
                    ...
                    temp_vic, Gamma_temp = Opt_Vic_Const(G_r, s, t, budget, rate, temp_tra, Gamma_Tra, restriction);
            ...
            # ------ Different Capacities
            Name1 = "Results/Results_"+str(n)+"/DifferentCapacities/Results_O-BBNIP2_Network_"+str(n)+"_"+str(budget)+"_"+str(rate)+".txt";
            
            # # ------- Same Capacities
            # Name1 = "Results/Results_"+str(n)+"/SameCapacities/Results_O-BBNIP2_Network_"+str(n)+"_"+str(budget)+"_"+str(rate)+".txt";
            
            # # --------- Operations Same Capacities
            # Name1 = "Results/Results_"+str(n)+"/OperationsSameCapacities/Results_O-BBNIP2_Network_"+str(n)+"_"+str(budget)+"_"+str(rate)+".txt";
