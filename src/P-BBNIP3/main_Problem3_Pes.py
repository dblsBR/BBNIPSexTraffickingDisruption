...
from MFNIP import*;
from Pessimistic_Constrained import*;
from Mod_MFNIP_Pessimistic import*;
...
for n in range(1, nNets+1):
    ...
    Name = "Results/Results_"+str(n)+"/DifferentCapacities/Results_P-BBNIP3_"+str(n)+"_.csv"
    print('\n\nDifferent Capacities\n')
    
    # # ------ Same Capacities
    # network = "Networks/SameCapacities/Net10_"+str(n)+"_SameCap.csv";
    # Name = "Results/Results_"+str(n)+"/SameCapacities/Results_P-BBNIP3_"+str(n)+"_.csv"
    # print('\n\nSame Capacities\n')
    
    ## ------ Operations Same Capacities
    # network = "Networks/OperationsSameCapacities/Net10_"+str(n)+"_OpSameCap.csv";
    # Name = "Results/Results_"+str(n)+"/OperationsSameCapacities/Results_P-BBNIP3_"+str(n)+"_.csv"
    # print('\n\nOperations Same Capacities\n')
    ...
    for budget in Budget:
        ...
        for rate in Rate:
            ...
            obj_victims, Gamma_Vic = Pessimistic (G_r, s, t, budget, rate, restriction);
            
            obj_revenue, Gamma_Rev = MFNIP (G_r, s, t, budget, rate, restriction);
                        
            obj_vic_const, Gamma_Vic_const = Pessimistic_Constrained (G_r, s, t, budget, obj_revenue, Gamma_Rev, restriction);
            
            obj_rev_const, Gamma_Rev_const =  Mod_MFNIP_Pessimistic (G_r, s, t, budget, obj_victims, Gamma_Vic, restriction); 
            ...
            if delta == 0:
                ...
                while temp_vic < obj_vic_const:    
                    ...
                    temp_rev, Gamma_temp = Mod_MFNIP_Pessimistic (G_r, s, t, budget, temp_vic, Gamma_Vic, restriction);
            ...
            # ------ Different Capacities
            Name1 = "Results/Results_"+str(n)+"/DifferentCapacities/Results_P-BBNIP3_Network_"+str(n)+"_"+str(budget)+"_"+str(rate)+".txt";
            
            # # ------- Same Capacities
            # Name1 = "Results/Results_"+str(n)+"/SameCapacities/Results_P-BBNIP3_Network_"+str(n)+"_"+str(budget)+"_"+str(rate)+".txt";
            
            # # --------- Operations Same Capacities
            # Name1 = "Results/Results_"+str(n)+"/OperationsSameCapacities/Results_P-BBNIP3_Network_"+str(n)+"_"+str(budget)+"_"+str(rate)+".txt";
